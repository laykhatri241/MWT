    ...
    <v-footer :padless="true">
      <v-card flat tile width="100%" class="secondary white--text text-center">
        ...
        <v-card-text class="white--text pt-0">
          For every sale you miss because you're too enthusiastic, you will miss
          a hundred because you're not enthusiastic enough.” “Every choice you
          make has an end result.” "Your attitude, not your aptitude, will
